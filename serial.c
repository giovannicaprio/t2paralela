...
Código adaptado de https://github.com/ahme5760/Game_of_Life_MPI

Basicamente as adaptações feitas foram para melhorar a forma como o 
tabuleiro se apresenta para o jogador
